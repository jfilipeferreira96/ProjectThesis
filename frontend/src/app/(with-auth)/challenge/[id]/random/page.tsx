        ...
        <>
          ...
          <div className={classes.footer}>
            ...
            {currentQuestion === questions.length - 1 ? (
              <button onClick={() => endChallenge()} disabled={false} className={classes.button}>
                Finish
              </button>
            ) : (
              <button onClick={() => onClickNext(currentQuestion + 1)} disabled={false} className={classes.button}>
                Next
              </button>
            )}
          </div>
