  ...
  return (
    <>
      ...
      <Flex justify="space-between">
        <ThreeDButton color="gray" evensmaller mt="sm" onClick={() => router.push(`${routes.challenge.url}/${id}/settings`)} type="button">
          Back
        </ThreeDButton>
        <Flex>
          <ThreeDButton color="gray" evensmaller mt="sm" onClick={open} mr="sm" type="button">
            Preview
          </ThreeDButton>
